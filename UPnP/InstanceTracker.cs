...
//		}
        ...
        {
            BeginInvoke(new EventLogger.EventHandler(OnEventSinkEx), new object[4] { LogType, origin, trace, information });
        }
			...
			lock(this)
			{
				switch(LogType)
				{
					case EventLogEntryType.Information:
						ImageIndex = 0;
						if (!showInformationMenuItem.Checked){return;}
						break;
					case EventLogEntryType.Warning:
						ImageIndex = 1;
						if (!showWarningsMenuItem.Checked){return;}
						break;
					case EventLogEntryType.Error:
						ImageIndex = 2;
						if (!showExceptionsMenuItem.Checked){return;}
						break;
					case EventLogEntryType.SuccessAudit:
						ImageIndex = 3;
						if (!showAuditMenuItem.Checked){return;}
						break;
					default:
						ImageIndex = 4;
						break;
		...
		private void showExceptionsMenuItem_Click(object sender, EventArgs e)
		{
			...
			showExceptionsToolBarButton.Pushed = showExceptionsMenuItem.Checked;
			EventLogger.ShowAll = showAuditMenuItem.Checked || showInformationMenuItem.Checked || showExceptionsMenuItem.Checked || showExceptionsMenuItem.Checked;
		}
