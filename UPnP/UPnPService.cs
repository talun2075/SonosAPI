...
namespace OSTL.UPnP
{
    ...
    public class ReturnArgumentAttribute : Attribute
    {
    ...
    /// from the UPnPService. If you call <see>
    ///         <cref>DelayInvokeRespose</cref>
    ///     </see>
    ///     and give it
    /// a Unique handle, then throw this exception, then from any thread you can call 
    /// <see cref="OSTL.UPnP.UPnPService.DelayedInvokeResponse"/> to complete the transaction.
    ...
    public class XMLParsingException : Exception
    {
        ...
        {
            return base.ToString() + " near line " + line + ", position " + position;
        }
    ...
    /// </para>
    /// </summary>
    /// <exception cref="OSTL.UPnP.UPnPStateVariable.CannotRemoveException">This gets thrown if an attempt is made to remove
    ...
    /// </list></exception>
    /// <exception cref="OSTL.UPnP.UPnPStateVariable.OutOfRangeException">
    ...
    public class UPnPStateVariable : ICloneable
    {
        ...
        public void SetRange(Object Min, Object Max, Object Step)
        {
            ...
            if (Min != null)
            {
                ...
                {
                    EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed (minimum value): " + ConvertFromUPnPType(VarType).FullName +
            ...
            if (Max != null)
            {
                ...
                {
                    EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed (maximum value): " + ConvertFromUPnPType(VarType).FullName +
            ...
            if (Step != null)
            {
                ...
                {
                    EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed (step value): " + ConvertFromUPnPType(VarType).FullName +
        ...
        internal void Validate(Object NewVal)
        {
            ...
            {
                EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed: " + ConvertFromUPnPType(VarType).FullName +
            ...
            if (AllowedStringValues != null)
            {
                ...
                #region talun
                //##Ta Lun## Die Liste mit den Erlaubten Argumenten Überschrieben und um ON_* ergänzt, da dies falsch in Sonos hinterlegt ist.
                if (OK == false)
                {
                    if (Name == "A_ARG_TYPE_Recurrence")
                    {
                        if (((string)NewVal).Contains("ON_"))
                            OK = true;
                    }
                ...
                if (OK == false)
                {
                    EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed: " + NewVal + " NOT in allowed value list");
                    throw (new UPnPTypeMismatchException(NewVal + " NOT in allowed value list"));
                }
            }
            ...
            if (MinVal != null)
            {
                ...
                {
                    EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed: " + "Specified value: " + NewVal + " must be >= " + MinVal);
                    throw (new OutOfRangeException("Specified value: " + NewVal + " must be >= " + MinVal));
                }
            }
            if (MaxVal != null)
            {
                ...
                {
                    EventLogger.Log(this, EventLogEntryType.Error, "Type Checking Failed: " + "Specified value: " + NewVal + " must be <= " + MaxVal);
                    throw (new OutOfRangeException("Specified value: " + NewVal + " must be <= " + MaxVal));
                }
            }
        }
        ...
        internal string BuildProperty()
        {
            ...
            XMLPayLoad += "<" + Name + ">" + UPnPService.SerializeObjectInstance(Value) + "</" + Name + ">\n";
            XMLPayLoad += "</e:property>\n";
            return (XMLPayLoad);
        }
        ...
        public virtual Object Value
        {
            ...
            set
            {
                ...
                CurrentValue = value;
                if (SendEvent && (ParentService != null))
                {
                    ParentService.SendEvents(this);
                }
                if ((OnModified != null) && Changed)
                {
        ...
        internal void GetStateVariableXML(XmlTextWriter XDoc)
        {
            ...
            if (ComplexType != null)
            {
                ...
                XDoc.WriteAttributeString("type", OwningService.ComplexType_NamespacePrefix[ComplexType.Name_NAMESPACE] + ":" + ComplexType.Name_LOCAL);
    ...
    public class UPnPAction : ICloneable
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ParentService != null && Target.ParentService != null)
            {
                if (ParentService.ServiceURN == Target.ParentService.ServiceURN && Target.Name == Name)
                {
                    return (true);
                }
                return (false);
        ...
        public override int GetHashCode()
        {
            if (ParentService != null && ParentService.ServiceURN != null &&
                Name != null)
            {
                string rv = ParentService.ServiceURN + ":" + Name;
        ...
        public object Clone()
        {
            UPnPAction A = (UPnPAction)MemberwiseClone();
            A.ArgList = new ArrayList();
            foreach (UPnPArgument arg in ArgList)
            {
        ...
        public bool ValidateArgs(UPnPArgument[] Args)
        {
            ...
            if (Args.Length != NumShouldHave)
            {
                ...
                throw (new UPnPInvokeException(Name, Args, "Incorrect number of Args"));
            }
            ...
            for (int i = 0; i < Args.Length; ++i)
            {
                ...
                if (a != null)
                {
                    if (a.Direction == "in")
                    {
                        ...
                        {
                            throw (new UPnPInvokeException(Name, Args, sve.Message));
                        }
                    }
                }
                else
                {
                    // Arg Not Found
                    throw (new UPnPInvokeException(Name, Args, Args[i].Name + " was not found in action: " + Name));
                }
            }
        ...
        public bool HasReturnValue
        {
            get
            {
                ...
                for (int x = 0; x < cnt; ++x)
                {
                    if (((UPnPArgument)ArgList[x]).IsReturnValue)
                    {
                        RetVal = true;
                        break;
                    }
        ...
        public UPnPArgument GetRetArg()
        {
            ...
            while (en.MoveNext())
            {
                if (((UPnPArgument)en.Current).IsReturnValue)
                {
        ...
        internal void GetXML(XmlTextWriter XDoc)
        {
            ...
            if ((ArgumentList.Length > 0) || HasReturnValue)
            {
                ...
                foreach (UPnPArgument ARG in ArgumentList)
                {
    ...
    public sealed class UPnPService : ICloneable
    {
        ...
        public void AddComplexType(UPnPComplexType t)
        {
            ...
            if (!ComplexType_NamespacePrefix.ContainsKey(t.Name_NAMESPACE))
            {
                ++ComplexType_NamespacePrefixIndex;
                ComplexType_NamespacePrefix[t.Name_NAMESPACE] = "ct" + ComplexType_NamespacePrefixIndex;
            }
        }
        ...
        public void RemoveComplexType(UPnPComplexType t)
        {
            ...
            ((ArrayList)ComplexType_NamespaceTables[t.Name_NAMESPACE]).Remove(t);
        ...
        public string GetComplexSchemaForNamespace(string ns)
        {
            ...
            XmlTextWriter X = new XmlTextWriter(m, Encoding.UTF8);
            ArrayList a = (ArrayList)ComplexType_NamespaceTables[ns];
        ...
        internal bool ValidationMode
        {
            set
            {
                foreach (UPnPStateVariable v in GetStateVariables())
                {
                    v.DO_VALIDATE = value;
                }
            }
        ...
        internal event SniffPacketHandler OnSniffPacket
        {
            add
            {
                ...
                {
                    InvocationPipeline.OnSniffPacket += SniffPacketSink;
        ...
        internal event SniffHandler OnSniff
        {
            add
            {
                ...
                if (Interlocked.Increment(ref SniffCount) == 1)
                {
                    InvocationPipeline.OnSniff += SniffSink;
                    InvocationPipeline.SetSniffHandlers();
                }
            }
            remove
            {
                ...
                if (Interlocked.Decrement(ref SniffCount) == 0)
                {
                    InvocationPipeline.OnSniff -= SniffSink;
                    InvocationPipeline.ReleaseSniffHandlers();
                }
        ...
        {
            __controlurl = s.__controlurl;
            __eventurl = s.__eventurl;
            EventCallbackURL = s.EventCallbackURL;
            EventURL = s.EventURL;
            if (SubscribeCounter != 0)
            {
                SubscribeCycle.Remove(GetHashCode());
                SubscribeCounter = 0;
                Subscribe(CurrentTimeout, null);
            }
            if (OnServiceReset != null) OnServiceReset(this);
        }

        public object Clone()
        {
            UPnPService T = (UPnPService)MemberwiseClone();
            T.StateVariables = new Hashtable();

            foreach (UPnPStateVariable sv in GetStateVariables())
            {
            ...
            foreach (UPnPAction A in Actions)
            {
        ...
        public struct AsyncInvokeInfo
        {
            ...
            public UPnPServiceInvokeHandler InvokeCB;
            public UPnPServiceInvokeErrorHandler ErrorCB;
        }

        internal UPnPService(double version)
        {
            InstanceTracker.Add(this);
            InvocationPipeline.OnResponse += HandleInvokeRequest;

            SubscribeCycleCallback = SubscribeCycleSink;
            SubscribeCycle.OnExpired += SubscribeCycleCallback;
        ...
        private void AddAction(UPnPAction action)
        {
            ...
            foreach (UPnPArgument arg in action.Arguments)
            {
                ...
                {
                    if (GetStateVariableObject(arg.__StateVariable.Name) == null)
                    {
                        AddStateVariable(arg.__StateVariable);
                    }
        ...
        public void Subscribe(int Timeout, UPnPEventSubscribeHandler CB)
        {
            ...
            if (processSubscribe == false)
            {
                ...
                foreach (UPnPStateVariable V in GetStateVariables()) V.InitialEvent();
            ...
            SSDP.ParseURL(__eventurl, out WebIP, out WebPort, out Tag);
            ...
            {
                request.AddTag("Host", "[" + RemoveIPv6Scope(addr.ToString()) + "]:" + WebPort);
            }
            request.AddTag("Callback", "<" + EventCallbackURL + ">");
            request.AddTag("NT", "upnp:event");
            request.AddTag("Timeout", NT);

            HTTPRequest SR = new HTTPRequest();
            SubscribeRequestTable[SR] = SR;
            SR.OnResponse += HandleSubscribeResponse;
        ...
        private void HandleSubscribeResponse(HTTPRequest sender, HTTPMessage response, object Tag)
        {
            ...
            if (response != null)
            {
                ...
                else
                {
                    ...
                    if (CurrentTimeout != 0)
                    {
                        EventLogger.Log(this, EventLogEntryType.SuccessAudit, "SUBSCRIBE [" + CurrentSID + "] Duration: " + CurrentTimeout + " <" + DateTime.Now.ToLongTimeString() + ">");
                        SubscribeCycle.Add(GetHashCode(), CurrentTimeout / 2);
                    }
                }
            }
            else
        ...
        public void UnSubscribe(UPnPEventHandler cb)
        {
            ...
            request.DirectiveObj = Tag;
            request.AddTag("Host", WebIP + ":" + WebPort); // WebIP is already formatted for IPv6
            request.AddTag("SID", CurrentSID);

            HTTPRequest UR = new HTTPRequest();
            SubscribeRequestTable[UR] = UR;
            UR.OnResponse += HandleUnsubscribeResponse;
            CurrentSID = "";
        ...
        private void RenewSink(HTTPRequest sender, HTTPMessage M, object Tag)
        {
            if (M != null)
            {
                ...
                {
                    // Renew Failed
                    EventLogger.Log(this, EventLogEntryType.SuccessAudit, "Renewal [" + CurrentSID + "] Error:" + M.StatusCode + " <" + DateTime.Now.ToLongTimeString() + ">");
                ...
                {
                    EventLogger.Log(this, EventLogEntryType.SuccessAudit, "Renewal [" + CurrentSID + "] OK <" + DateTime.Now.ToLongTimeString() + ">");
                    SubscribeCycle.Add(GetHashCode(), CurrentTimeout / 2);
                }
            }
            else
            {
                // Renew Failed
                EventLogger.Log(this, EventLogEntryType.SuccessAudit, "Renewal [" + CurrentSID + "] DeviceError <" + DateTime.Now.ToLongTimeString() + ">");

                SubscribeCycle.Remove(GetHashCode());
                SubscribeCounter = 0;
                PeriodicRenewFailedEvent.Fire(this);
            }
            SendEventTable.Remove(sender);
            sender.Dispose();
        }
        ...
        private String GetNewSID()
        {
            ...
            {
                ++EventSID;
                TheSID = "uuid:" + ParentDevice.UniqueDeviceName + "-" + ServiceID + "-" + EventSID;
            }
        ...
        private void ParseStateVarXml(String evented, String multicasted, XmlTextReader XMLDoc, int startLine)
        {
            ...
            if (HasDef)
            {
                var.DefaultValue = CreateObjectInstance(var.GetNetType(), DefaultValue);
            }
            if ((minval != null) && (maxval != null))
            {
                Object stepobj = null;
                if (stepval != null)
                {
                    try
                    {
                        stepobj = CreateObjectInstance(var.GetNetType(), stepval);
                    }
                    catch (Exception)
                    {
                        stepobj = null;
                ...
                try
                {
                    MIN = CreateObjectInstance(var.GetNetType(), minval);
                }
                catch (Exception)
                {
                ...
                try
                {
                    MAX = CreateObjectInstance(var.GetNetType(), maxval);
                }
                catch (Exception)
                {
        ...
        public byte[] GetSCPDXml()
        {
            ...
            XmlTextWriter XDoc = new XmlTextWriter(mstr, Encoding.UTF8);
            ...
            IDictionaryEnumerator en = ComplexType_NamespacePrefix.GetEnumerator();
            while (en.MoveNext())
            {
        ...
        public void InvokeAsync(String MethodName, UPnPArgument[] InVarArr,
            object Tag,
            UPnPServiceInvokeHandler InvokeCallback,
            UPnPServiceInvokeErrorHandler ErrorCallback)
        {
            HTTPMessage request = new HTTPMessage();
            if (InVarArr == null)
            {
            ...
            XmlTextWriter W = new XmlTextWriter(mstream, Encoding.UTF8);
            ...
            for (int ID = 0; ID < InVarArr.Length; ++ID)
            {
                ...
                {
                    W.WriteElementString(InVarArr[ID].Name, SerializeObjectInstance(InVarArr[ID].DataValue));
                }
            }
            W.WriteEndElement();
            W.WriteEndElement();
        ...
        private void HandleInvokeRequest(HTTPRequest sender, HTTPMessage response, object Tag)
        {
                    ...
                    if ((response.StatusCode == 500) && (response.BodyBuffer.Length > 0))
                    {
                        ...
                        try
                        {
                            ...
                            EventLogger.Log(this, EventLogEntryType.Error,
                                "UPnP Action <" + state.MethodName + "> Error [" + ce.ErrorCode + "] " + ce.ErrorDescription);
                        }
                        catch (Exception ex)
                        {
                            ce = null;
                            EventLogger.Log(ex,"HTTP Fault invoking " + state.MethodName + " : " + response.StatusData);
            ...
            int StartIDX = 0;
            if (((UPnPAction)RemoteMethods[state.MethodName]).HasReturnValue)
            {
        ...
        internal object InvokeLocal(String MethodName, ref ArrayList VarList)
        {
            ...
            {
                UPnPStateVariable V = GetStateVariableObject(MethodName, _ARG.Name);
                try
                {
                    V.Validate(CreateObjectInstance(V.GetNetType(), (string)_ARG.DataValue));
                }
                catch (Exception ex)
                {
            ...
            UPnPAction A = GetAction(MethodName);
            if (A == null)
            {
            ...
            if (A.SpecialCase != null)
            {
                ...
                foreach (UPnPArgument _arg in VarList)
                {
                    _arg.DataValue = CreateObjectInstance(A.GetArg(_arg.Name).RelatedStateVar.GetNetType(), (string)_arg.DataValue);
                }
        ...
        public void AddMethod(String MethodName)
        {
            ...
            ESV = GetStateVariables();
            UPnPStateVariable sv;
            MethodInfo minfo = ServiceInstance.GetType().GetMethod(MethodName);
            if (minfo == null)
            {
                throw (new Exception(MethodName + " does not exist in " + ServiceInstance.GetType()));
            }
            ...
            if (minfo.ReturnType.FullName != "System.Void")
            {
                if (minfo.GetCustomAttributes(true).Length > 0)
                {
                    ...
                    {
                        if (a.GetType() == typeof(ReturnArgumentAttribute))
                        {
                ...
                if (DontCreate == false) AddStateVariable(sv);
            }
            ...
            if (minfo.ReturnType.FullName != "System.Void")
            {
                ...
                ARG.StateVarName = GetStateVariableObject(MethodName, retname).Name;
            ...
            foreach (ParameterInfo p in pinfo)
            {
                ...
                ARG.ParentAction = NewAction;
                ARG.StateVarName = GetStateVariableObject(MethodName, p.Name).Name;
                NewAction.AddArgument(ARG);
            }
            AddAction(NewAction);
        }
        ...
        public void SetStateVariable(String VarName, Object VarValue)
        {
            ...
            {
                throw (new Exception(string.Format("Service '{0}' does not contain variable '{1}'", ServiceID, VarName)));
            }
        }
        ...
        public void AddStateVariable(UPnPStateVariable NewVar)
        {
            ...
            for (int x = 0; x < Nodes.Length; ++x)
            {
                ...
                if (ArgTable.ContainsKey(Nodes[x].ArgName))
                {
                ...
                if (A != null)
                {
                    ...
                    if (Argument == null)
                    {
                        throw (new Exception(string.Format("There is no parameter named {0} for the {1}.{2} method.", Nodes[x].ArgName, ServiceInstance.GetType(), Nodes[x].ActionName)));
                    }
        ...
        {
            UPnPStateVariable[] x = GetStateVariables();
        ...
        {
            return (BuildEventXML(GetStateVariables()));
        }

        private byte[] BuildEventXML(UPnPStateVariable[] vars)
        {
            MemoryStream ms = new MemoryStream();
            XmlTextWriter XMLDoc = new XmlTextWriter(ms, Encoding.UTF8);
                ...
                if (XMLDoc.LocalName == "propertyset")
                {
                    ...
                    while ((XMLDoc.LocalName != "propertyset") && (XMLDoc.EOF == false))
                    {
                        ...
                        if (StateVariables.ContainsKey(name))
                        {
                            ...
                            try
                            {
                                Object RetVal = CreateObjectInstance(var.GetNetType(), val);
                                var.Value = RetVal;
                    ...
                    if ((sinfo.Expires > DateTime.Now.Ticks) || (sinfo.Expires == -1))
                    {
                        ...
                        for (int x = 0; x < EventURLS.Length; ++x)
                        {
                            try
                            {
                                ...
                                if (dest.AddressFamily == AddressFamily.InterNetwork) Packet.AddTag("Host", EventURLS[x].Host + ":" + EventURLS[x].Port);
                                if (dest.AddressFamily == AddressFamily.InterNetworkV6) Packet.AddTag("Host", "[" + RemoveIPv6Scope(EventURLS[x].Host) + "]:" + EventURLS[x].Port);
                                Packet.AddTag("SID", sinfo.SID);
        ...
        public void DelayedInvokeResponse(long id, object RetArg, UPnPArgument[] OutArgs, UPnPCustomException e)
        {
            ...
            {
                resp = ParentDevice.ParseInvokeResponse(iis.MethodName, iis.SOAPAction, ServiceURN, RetArg, OutArgs);
            }
