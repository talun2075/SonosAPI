...
namespace TagLib.Mpeg4 {
	...
	public class AppleTag : TagLib.Tag, IEnumerable<Box>
	{
        ...
        #region talun
        /// <summary>
        /// Get and sets the Rating of a Song
        /// </summary>
        public override string Rating
        {
            get
            {
                string[] text = GetText(BoxType.Rate);
                return text.Length == 0 ? null : text[0];
            }
            set
            {
                SetText(BoxType.Rate, value);
            }
        }
        public override string Mood
        {
            get { return GetDashBox("com.apple.iTunes", "MOOD"); }
            set { SetDashBox("com.apple.iTunes", "MOOD", value); }
		}
         public override string Tempo
        {
            get { return GetDashBox("com.apple.iTunes", "TEMPO"); }
            set { SetDashBox("com.apple.iTunes", "TEMPO", value); }
        }
         public override string Occasion
         {
             get { return GetDashBox("com.apple.iTunes", "OCCASION"); }
             set { SetDashBox("com.apple.iTunes", "OCCASION", value); }
         }
         public override string MMCustom1
         {
             get { return GetDashBox("com.apple.iTunes", "CUSTOM1"); }
             set { SetDashBox("com.apple.iTunes", "CUSTOM1", value); }
         }
         public override string MMCustom2
         {
             get { return GetDashBox("com.apple.iTunes", "CUSTOM2"); }
             set { SetDashBox("com.apple.iTunes", "CUSTOM2", value); }
         }
         public override string MMCustom3
         {
             get { return GetDashBox("com.apple.iTunes", "CUSTOM3"); }
             set { SetDashBox("com.apple.iTunes", "CUSTOM3", value); }
         }
         public override string MMCustom4
         {
             get { return GetDashBox("com.apple.iTunes", "CUSTOM4"); }
             set { SetDashBox("com.apple.iTunes", "CUSTOM4", value); }
         }
         public override string MMCustom5
         {
             get { return GetDashBox("com.apple.iTunes", "CUSTOM5"); }
             set { SetDashBox("com.apple.iTunes", "CUSTOM5", value); }
         }
        #endregion talun
        /// <summary>
