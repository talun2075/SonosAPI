...
namespace TagLib.Ogg
{
    ...
    public class XiphComment : TagLib.Tag, IEnumerable<string>
    {
        ...
        #region talun
        /// <summary>
        /// Gets and Set the Rating
        /// </summary>
        public override string Rating
        {
            get { return GetFirstField("RATING"); }
            set { SetField("RATING", value); }
        }
        /// <summary>
        /// Get and Set the Mood (Stimmung)
        /// </summary>
        public override string Mood
        {
            get { return GetFirstField("MOOD"); }
            set { SetField("MOOD", value); }
        }
        /// <summary>
        /// Read and set the Occasion (Gelegenheit)
        /// </summary>
        public override string Occasion
        {
            get { return GetFirstField("OCCASION"); }
            set { SetField("OCCASION", value); }
        }
        /// <summary>
        /// Get and Set the Tempo
        /// </summary>
        public override string Tempo
        {
            get { return GetFirstField("TEMPO"); }
            set { SetField("TEMPO", value); }
        }
        /// <summary>
        /// Read or set the Mediamonkey Custom 1 Field
        /// </summary>
        public override string MMCustom1
        {
            get { return GetFirstField("CUSTOM1"); }
            set { SetField("CUSTOM1", value); }
        }
        /// <summary>
        /// Read or set the Mediamonkey Custom 1 Field
        /// </summary>
        ...
        {
            get { return GetFirstField("CUSTOM2"); }
            set { SetField("CUSTOM2", value); }
        }        /// <summary>
        /// Read or set the Mediamonkey Custom 1 Field
        /// </summary>
        public override string MMCustom3
        {
            get { return GetFirstField("CUSTOM3"); }
            set { SetField("CUSTOM3", value); }
        }        /// <summary>
        /// Read or set the Mediamonkey Custom 1 Field
        /// </summary>
        public override string MMCustom4
        {
            get { return GetFirstField("CUSTOM4"); }
            set { SetField("CUSTOM4", value); }
        }        /// <summary>
        /// Read or set the Mediamonkey Custom 1 Field
        /// </summary>
        public override string MMCustom5
        {
            get { return GetFirstField("CUSTOM5"); }
            set { SetField("CUSTOM5", value); }
        }
        /// <summary>
        /// Geht the Publisher
        /// </summary>
