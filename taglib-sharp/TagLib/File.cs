...
namespace TagLib {
	...
	public abstract class File : IDisposable
	{
	    ...
	    ///         <cref>TagTypes.AllTags</cref>
	    ///     </see>
	    ///     as <paramref name="types" />.
	    /// </remarks>
	    ...
	    ///     <see>
	    ///         <cref>GetTag(TagTypes,bool)</cref>
	    ///     </see>
	    ///         provides the option
		            ...
		            ByteVector after)
		{
			...
			*/
		    ...
		    int read_size = (int) Math.Min (buffer_offset, buffer_size);
			...
			for (buffer = ReadBlock (read_size); buffer.Count > 0;
				...
				// 2TODO: (1) previous partial match
		...
		public void Insert (ByteVector data, long start, long replace)
		{
			...
			while (buffer_length != 0) {
				...
				Array.Copy (about_to_overwrite, 0,
					buffer, 0, bytes_read);
